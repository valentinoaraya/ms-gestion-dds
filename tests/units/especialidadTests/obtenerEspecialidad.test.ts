...
test("debería obtener una especialidad por ID de la base de datos", async () => {
    ...
    expect(especialidadObtenida?.id).toBe(especialidadCreada.id);
    expect(especialidadObtenida?.nombre).toBe(especialidad.nombre);
})
